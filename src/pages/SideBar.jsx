...
const SideBar = () => {
      ...
      const { username,setLogin,setUsername,setDateCreated,setres } = useContext(UserContext)
            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-[#f9fdfb] dark:bg-gray-800">
               <ul className="space-y-2 font-medium">
                  <li className="flex items-center p-2 text-gray-900 rounded-lg   group">
                     ...
                     <img src="/img/todo-icon.png" alt="" className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 " aria-hidden="true" />
                     <span className="ms-3 font-bold">TWINKLIN</span>
           
                  </li>
     
                  <li className=''>
                     <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg cursor-default   group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Hello! <span className='font-bold'>{username}</span></span>
                     </a>
                  </li>
                  <li>
                     <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg   group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">User Documentation</span>
                     </a>
                  </li>
                  <li>
