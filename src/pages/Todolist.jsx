...
const Todolist = () => {
   ...
   const { username,isLogin,isOpenAdd, setOpenAdd } = useContext(UserContext)
      ...
      <>
         {isLogin ? (
            ...
            <div className="flex flex-col">
               ...
               <div className="grid grid-cols-1 md:grid-cols-1 gap-4 md:mx-[15rem]">
         ...
         >
            <img src={imageSrc} alt="" onClick={handleOpenAdd} />
               ...
               {isOpenAdd && <div className="flex justify-center border">
                <Add />
               </div>}
            </>
